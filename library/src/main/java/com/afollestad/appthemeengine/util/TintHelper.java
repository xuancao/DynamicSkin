...
public final class TintHelper {
    ...
    @NonNull
    private static ColorStateList getPressedColorStateList(@ColorInt int normal, @ColorInt int pressed) {
        return new ColorStateList(new int[][]{
    ...
    public static void setTintSelector(@NonNull View view, @ColorInt int color, boolean darker, boolean useDarkTheme) {
        ...
        final int pressed = Util.shiftColor(color, darker ? 0.9f : 0.6f);
        ...
        if (view instanceof Button) {
            sl = getPressedColorStateList(color, pressed);
            ...
            //  button.setTextColor(getPressedColorStateList(defaultTextColor, Color.WHITE));
    ...
    public static void setTint(@NonNull ProgressBar progressBar, @ColorInt int color, boolean skipIndeterminate) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            // progressBar.getProgressDrawable().setColorFilter(color, mode);
            {
                ...
                p.setColor(color);
                ScaleDrawable progress = new ScaleDrawable(p, Gravity.LEFT | Gravity.FILL_VERTICAL, 1, 1);
                //   ClipDrawable progress = new ClipDrawable(p, Gravity.LEFT, ClipDrawable.HORIZONTAL);
//                GradientDrawable background = new GradientDrawable();
//                background.setColor(shapeDrawable.getPaint().getColor());
//                background.setCornerRadius(10);
                LayerDrawable pd = new LayerDrawable(new Drawable[]{layerDrawable.getDrawable(0), progress});
